...
3. Select a column from the dropdown menu **Select a column to check its Distribution**
4.  Select **Quantity**
5. You get the p-value and a quantile-quantile plot for the column.

 <img width="600" alt="show data 2" src="https://github.com/user-attachments/assets/7e618dfb-837a-4d43-8480-7fbfbcbcb237" />

6. **Conclusion:** The data points are not normally distributed.
...
<img width="1919" height="929" alt="Image" src="https://github.com/user-attachments/assets/eb0e62eb-6ae6-4d69-b44c-e6db1e0d8f0c" />
 6. Now, select **Sales** and **Sub-Category** - sales being a numeric column and sub-category being a categorical column 
 7. For a mix of numeric and categorical columns, Kruskal-Wallis test is performed and a box plot is visualized 
...
<img width="1919" height="947" alt="Image" src="https://github.com/user-attachments/assets/f311b6e6-fd57-44cd-8260-820f150cfa7e" />
 9. Now, select **Ship Mode** and **Sub-Category** - both categorical variables. 
 10. When both columns are categorical, we get a chi-square test, contingency table, and heatmap visualization.
